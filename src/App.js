    ...
    return (
      <div className="App">
        <header className="App-header">
          <h1 className="App-title">Connect 4 in React.js</h1>
          <Game/>
        </header>
      </div>
    );
...
class Game extends React.Component {
  ...
  render(){
    return (
      <div>
        <h1>{this.state.winner > 0 ? this.state.winner == 1 ? "Player 2 wins!" : "Player 1 wins!" : this.state.player? "Player 2 (black)" : "Player 1 (red)"}</h1>
